...
using LatencyUpdater = std::function<void(unplug::Index processorId, uint64_t processorLatency)>;
...
public:
  ...
  explicit SharedDataWrapper(LatencyUpdater const& latencyUpdater = [](auto, auto) {})
    : data(latencyUpdater)
  {}
